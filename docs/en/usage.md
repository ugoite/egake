...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| Read-only CSV list/search      | [`examples/csv-readonly`](https://github.com/ugoite/ikashita/tree/main/examples/csv-readonly)                                                                      | `cargo run -p ikashita-cli -- list examples/csv-readonly --resource catalog --query ada` | CSV without an `id`, schema/list-only capabilities, case-insensitive search, sorting, pagination |
| Multi-resource project         | [`examples/multi-resource`](https://github.com/ugoite/ikashita/tree/main/examples/multi-resource)                                                                  | `cargo run -p ikashita-cli -- test examples/multi-resource`                              | Two resources, two schemas/data files, deterministic bundle and validation                       |
...
| Browser/JS embedded provider   | [`examples/js-embedded`](https://github.com/ugoite/ikashita/tree/main/examples/js-embedded)                                                                        | `deno test examples/js-embedded/main_test.ts`                                            | Host-owned provider injection, list/search, and declared provider action invoke                  |
...
| Ugoite client adapter          | [`examples/ugoite-entries`](https://github.com/ugoite/ikashita/tree/main/examples/ugoite-entries)                                                                  | `deno test examples/ugoite-entries/adapter_test.ts`                                      | Transparent CRUD/action delegation to a host-owned client                                        |
