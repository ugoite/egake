...
CSV providers. Both resources are read-only and are configured together in
...
The generated bundle contains the application definition only; CSV records are
